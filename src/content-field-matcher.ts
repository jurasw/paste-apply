...
export function isCustomDropdown(input: HTMLInputElement): boolean {
...
export function findDropdownOption(input: HTMLInputElement, searchValue: string): HTMLElement | null {
...
export async function fillCustomDropdown(input: HTMLInputElement, value: string): Promise<boolean> {
  try {
    input.focus();
    input.click();
