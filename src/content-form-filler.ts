...
export function uploadResumeFile(base64Data: string, fileName: string, fileType: string): boolean {
...
export function fillForm(): void {
  ...
  chrome.storage.sync.get([
    ...
    console.log('[AutoFill] Profile data:', Object.keys(profileData).filter(k => profileData[k as keyof ProfileData]));
    let filledCount = 0;
